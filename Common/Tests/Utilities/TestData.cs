...
namespace TestUtilities
{
    ...
    {
        private const string BinariesAltSourcePath = @"Tests";
        private const string BinariesSourcePath = @"BuildOutput\" +
#if DEBUG
            @"Debug" +
#else
            @"Release" + 
        ...
        private const string BinariesOutPath = "";

        private const string DataAltSourcePath = @"Tests\TestData";
        private const string DataOutPath = @"TestData";
