...
namespace Microsoft.NodejsTools
{
    internal static class Guids
    {
        ...
        private const string ConnectedServicesCmdSetString = "{A114CF9C-BD45-4A48-92EF-D9BBBC0B3DF0}";
        public static readonly Guid ConnectedServicesCmdSet = new Guid(ConnectedServicesCmdSetString);

        private const string NuGetManagerCmdSetString = "{25fd982b-8cae-4cbd-a440-e03ffccde106}";
        public static readonly Guid NuGetManagerCmdSet = new Guid(NuGetManagerCmdSetString);
