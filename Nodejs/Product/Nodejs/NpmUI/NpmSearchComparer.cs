...
{
    class NpmSearchComparer : IComparer<IPackage>
    {
        ...
        public int Compare( IPackage x, IPackage y )
        {
            ...
            if ( x.Name == _filterString )
            {
                ...
                {
                    return 0;   //  In theory should never happen since package names have to be unique
                }
                else
                {
            ...
            else
            {
                ...
                else if ( x.Name.StartsWith( _filterString ) )
                {
                    ...
                    {
                        return -1;  // Matches at the beginning are better than matches in the string
                    }
                }
