...
namespace Microsoft.NodejsTools.Analysis {
    ...
    class ComprehensionAnalysisUnit : AnalysisUnit {
        private readonly JsAst _parent;
        private readonly AnalysisUnit _outerUnit;

        public ComprehensionAnalysisUnit(Comprehension node, JsAst parent, InterpreterScope scope, AnalysisUnit outerUnit)
    ...
    class GeneratorComprehensionAnalysisUnit : ComprehensionAnalysisUnit {
        public GeneratorComprehensionAnalysisUnit(Comprehension node, JsAst parent, AnalysisUnit outerUnit, InterpreterScope outerScope)
            : base(node, parent,
    ...
    class SetComprehensionAnalysisUnit : ComprehensionAnalysisUnit {
        public SetComprehensionAnalysisUnit(Comprehension node, JsAst parent, AnalysisUnit outerUnit, InterpreterScope outerScope)
            : base(node, parent,
    ...
    class DictionaryComprehensionAnalysisUnit : ComprehensionAnalysisUnit {
        public DictionaryComprehensionAnalysisUnit(Comprehension node, JsAst parent, AnalysisUnit outerUnit, InterpreterScope outerScope)
            : base(node, parent,
    ...
    class ListComprehensionAnalysisUnit : ComprehensionAnalysisUnit {
        public ListComprehensionAnalysisUnit(Comprehension node, JsAst parent, AnalysisUnit outerUnit, InterpreterScope outerScope)
            : base(node, parent,
