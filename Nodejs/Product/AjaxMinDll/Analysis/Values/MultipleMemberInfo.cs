...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    sealed class MultipleMemberInfo : AnalysisValue, IModule {
        ...
        public override IAnalysisSet Call(Node node, AnalysisUnit unit, IAnalysisSet @this, IAnalysisSet[] args) {
            var res = AnalysisSet.Empty;
            foreach (var member in _members) {
                res = res.Union(member.Call(node, unit, @this, args));
            }
            return res;
        }
        ...
        public override IDictionary<string, IAnalysisSet> GetAllMembers(NodejsTools.Interpreter.IModuleContext moduleContext) {
        ...
        IAnalysisSet IModule.GetModuleMember(Node node, AnalysisUnit unit, string name, bool addRef, EnvironmentRecord linkedScope, string linkedName) {
            var res = AnalysisSet.Empty;
            foreach (var member in _members.OfType<IModule>()) {
