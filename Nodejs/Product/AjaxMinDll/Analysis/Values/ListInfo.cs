...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    class ListInfo : SequenceInfo {
        ...
        private IAnalysisSet ListAppend(Node node, AnalysisUnit unit, IAnalysisSet[] args) {
            if (args.Length == 1) {
        ...
        private IAnalysisSet ListPop(Node node, AnalysisUnit unit, IAnalysisSet[] args) {
            return UnionType;
        }

        private IAnalysisSet ListInsert(Node node, AnalysisUnit unit, IAnalysisSet[] args) {
            if (args.Length == 2) {
        ...
        private IAnalysisSet ListExtend(Node node, AnalysisUnit unit, IAnalysisSet[] args) {
            if (args.Length == 1) {
