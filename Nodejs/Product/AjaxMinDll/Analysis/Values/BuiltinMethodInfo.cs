...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    internal class BuiltinMethodInfo : BuiltinNamespace<IPythonType> {
        ...
        public BuiltinMethodInfo(IPythonMethodDescriptor method, JavaScriptAnalyzer projectState)
        ...
        public BuiltinMethodInfo(IPythonFunction function, PythonMemberType memType, JavaScriptAnalyzer projectState)
            : base(projectState.Types[BuiltinTypeId.BuiltinMethodDescriptor], projectState) {
            _memberType = memType;
            _function = function;
            _returnTypes = Utils.GetReturnTypes(function, projectState);
