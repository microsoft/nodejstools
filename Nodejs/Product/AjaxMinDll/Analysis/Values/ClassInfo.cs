...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    internal class ClassInfo : AnalysisValue, IReferenceableContainer {
        ...
        private IAnalysisSet AddCall(Node node, AnalysisUnit unit, IAnalysisSet[] argumentVars) {
        ...
        public override IEnumerable<LocationInfo> Locations {
            get {
                if (_declVersion == DeclaringModule.AnalysisVersion) {
                    var start = ClassDefinition.Lookup.GetStart(ClassDefinition.GlobalParent);
        ...
        private static bool IsFirstForMroUnion(ClassDefinition cd1, ClassDefinition cd2) {
            ...
            return cd1.Lookup.Name.CompareTo(cd2.Lookup.Name) > 0;
        }
