...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    class ObjectBuiltinClassInfo : BuiltinClassInfo {
        ...
        public ObjectBuiltinClassInfo(IPythonType classObj, JavaScriptAnalyzer projectState)
        ...
        private IAnalysisSet ObjectNew(Node node, Analysis.AnalysisUnit unit, IAnalysisSet[] args) {
            if (args.Length >= 1) {
