...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    class ListBuiltinClassInfo : SequenceBuiltinClassInfo {
        public ListBuiltinClassInfo(IPythonType classObj, JavaScriptAnalyzer projectState)
        ...
        internal override SequenceInfo MakeFromIndexes(Node node, ProjectEntry entry) {
            if (_indexTypes.Count > 0) {
                ...
                return new ArrayInfo(vals, this, node, entry);
            } else {
                return new ArrayInfo(VariableDef.EmptyArray, this, node, entry);
            }
        }
    }
#endif
