...
namespace Microsoft.NodejsTools.Analysis.Values {
    ...
    internal class BoundMethodInfo : AnalysisValue {
        ...
        public override IAnalysisSet Call(Node node, AnalysisUnit unit, IAnalysisSet @this, IAnalysisSet[] args) {
            return _function.Call(node, unit, _instanceInfo.SelfSet, args);
        }
        ...
        public override string Description {
            get {
                ...
                result.Append(_function.FunctionObject.Name);
        ...
        public override IEnumerable<OverloadResult> Overloads {
            get {
                var p = _function.FunctionObject.ParameterDeclarations;
                ...
                yield return new SimpleOverloadResult(pp, _function.FunctionObject.Name, doc);
            }
        }
        ...
        public override string ToString() {
            var name = _function.FunctionObject.Name;
